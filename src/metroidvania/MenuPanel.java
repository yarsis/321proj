...
public class MenuPanel extends javax.swing.JPanel implements ActionListener {
     ...
     *
     * precondition Game area exists. postcondition Main menu is drawn.
     *
    ...
    /**
     * Function will remove previous buttons and draw a pause menu with "change
     * colors", "continue" and "exit" buttons.
     *
     * precondition Game area exists. postcondition Pause menu is drawn.
     *
     * @param g Graphics object used to generate visuals.
     *
     */
     ...
     * "player color", "background color" and "enemy color" buttons with their
     * respective colors.
     *
     * precondition Game area exists. postcondition Settings menu is drawn.
     *
     * @param g Graphics object used to generate visuals.
     */
    ...
    /**
     * Function will change the game state to pause. If the game is in any other
     * state, return to game state.
     *
     ...
     *
     * precondition Game area exists. postcondition Game over menu is drawn.
     *
    ...
    /**
     * Override for ActionListener actionPerformed method. Sets to have no
    ...
    /**
     * Function tries to return the rectangle for the "change colors" button. If
     * the button has not been created and it has been somehow clicked, return
     * exitRect to close the program.
     *
     * precondition Menu has been initialized.
     *
    ...
    /**
     * Function tries to return the rectangle for the "player color" button. If
     * the button has not been created and it has been somehow clicked, return
     * exitRect to close the program.
     *
     * precondition Menu has been initialized.
    ...
    /**
     * Function tries to return the rectangle for the "enemy color" button. If
     * the button has not been created and it has been somehow clicked, return
     * exitRect to close the program.
     *
     * precondition Menu has been initialized.
