 ...
 * of the background, then displays the game in a PlayPanel. It also adds key
 * and mouse listeners to enable response to key and mouse presses. Subclass of
 * JFrame, and is part of the View of the GUI.
 *
 * @author caden
 */
public class MainFrame extends javax.swing.JFrame {
    ...
    /**
     * Constructs a JPanel window that displays the game to the user and
     * responds to key and mouse input.
     */
    public MainFrame() {
