...
/**
 * This class represents the displayed game as a JPanel that inherits from
 * ActionListener. It generates all elements needed for gameplay and manages the
 * game state over time. PlayPanel is a subclass of JPanel anf makes up part of
 * the Model of the GUI. Being the main gameplay display, it aggregates the
 * Player, Projectile, Enemy and Terrain classes.
 *
...
public final class PlayPanel extends javax.swing.JPanel implements ActionListener {
    ...
    /**
     * Construct a PlayPanel that generates the default state of the game with a
     * player character, level, and points. Panel updates regularly to display
     * various events.
     */
    public PlayPanel() {
    ...
    /**
     * Function will call a class that randomly selects a terrain to generate,
     * forcing the first terrain to be the first level. Once the first level was
     * chosen, prevent it from being chosen.
     *
     * precondition Main window exists. postcondition Terrain has been
     * generated.
     */
    ...
    /**
     * Function will draw the game depending on its state. Overrides the paint
     * method to draw the game's specific graphics.
     *
     * precondition Terrain, player, enemies and projectiles, or menu, have been
     * initialized. postcondition Game is displayed and playable.
     *
    ...
    /**
     * Override of the actionPerformed method. Sets no response to action
     ...
     * Most keys will set player movement accordingly. Pressing the "Esc" key
     * button pauses the game, player cannot move down.
     *
    ...
    void keyPress(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_LEFT) {
            samus.setKeyLeft(true);
        }
        if (e.getKeyCode() == KeyEvent.VK_RIGHT) {
            samus.setKeyRight(true);
        }
        ...
        if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
            state = menu.switchPauseState(state);
        }
    }
    ...
    void keyRelease(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_SPACE) {
            samus.setKeyUp(false);
        }
        if (e.getKeyCode() == KeyEvent.VK_UP) {
            samus.setKeyUp(false);
        }
        if (e.getKeyCode() == KeyEvent.VK_LEFT) {
            samus.setKeyLeft(false);
        }
        if (e.getKeyCode() == KeyEvent.VK_RIGHT) {
            samus.setKeyRight(false);
        }
    ...
    /**
     * Function will allow user to click on the menu and the game area. If a
     * menu button is clicked, act accordingly. If clicked on the game area, the
     * player will shoot according to mouse position in relation to player. The
     * shots only happen if the mouse is far enough from the player.
     *
     ...
     *
     * precondition Game has been initialized. postcondition Score has been
     * changed.
     *
     ...
     *
     * precondition Game has been initialized. postcondition Player color has
     * been changed.
     *
     ...
     *
     * precondition Game has been initialized. postcondition Background color
     * has been changed.
     *
     * @param color The new color.
     */
     ...
     *
     * precondition Game has been initialized. postcondition Enemy's color has
     * been changed.
     *
     * @param color The new color.
     */
