 ...
 * and attributes can be modified.
 *
 * @author Henry Schulz
 */
public class Enemy {
     ...
     * @param game PlayPanel of the game being displayed. postcondition Enemy
     ...
     * @param color Color of the enemy. precondition Display area exists.
    ...
    /**
     * Function will check if a projectile hit the enemy. If it did, destroy the
     * enemy.
     *
     * precondition Display and enemy exists. postcondition Enemy was destroyed
     * if hit.
     *
    ...
    /**
     * Function will hide the enemy from the game area and mark it as destroyed.
     *
     * precondition Display and enemy exists. postcondition Enemy was hidden and
     * marked.
     */
    public void destroy() {
