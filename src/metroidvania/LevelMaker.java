...
/**
 * This class is a level generator that picks randomly from a pool of preset
 * terrains to display in the game for the player to navigate. The level maker
 * will create the first level if specified, and will avoid making the same
...
public class LevelMaker {
     ...
     * terrain set as 0.
     *
     * @param game PlayPanel representing the game levels are being generated
     * for.
     */
    ...
    /**
     * Function will delete the current terrain and all its contents, and use a
     * random integer to select a new terrain.
     *
     * @param firstLevel boolean that checks if the first level should be used.
     ...
     * avoiding the specified number. This code is limited to generating numbers
     * between 0 and 100. If the first level should be used, return its ID and
     * don't generate a number.
     *
     ...
     *
     * postcondition Terrain and enemies for level 0 are properly generated and
     * displayed.
     */
     ...
     *
     * postcondition Terrain and enemies for level 1 are properly generated and
     * displayed.
     */
     ...
     *
     * postcondition Terrain and enemies for level 2 are properly generated and
     * displayed.
     */
     ...
     *
     * postcondition Terrain and enemies for level 3 are properly generated and
     * displayed.
     */
     ...
     *
     * postcondition Terrain and enemies for level 4 are properly generated and
     * displayed.
     */
