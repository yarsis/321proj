...
/**
 * This class represents the game's player character as a colored rectangle. It
 * supports the status of the player's health and score, as well as various
...
public class Player {
     ...
     * coordinates passed in the parameter and other attributes set to default
     * values. Creates a hitbox with the player's attributes.
     *
    ...
    /**
     * Function will modify the player according to pressed keys and interaction
     * with the game.
     *
     * precondition Player and game area exists. postcondition Player has been
    ...
    public void set() {
        ...
        if (0 < xspeed && xspeed < 0.7) {
            xspeed = 0;
        }
        if (-0.7 < xspeed && xspeed < 0) {
            xspeed = 0;
        }
        ...
        if (keyUp) {
            ...
            for (int i = 0; i < game.gameTerrain.size(); i++) {
                ...
                if (ter.hitBox.intersects(hitBox)) {
                    yspeed = -8;
                }
            }
        }
        ...
        for (int i = 0; i < game.projList.size(); i++) {
            ...
            if (hitBox.intersects(proj.getHitBox())) {
                ...
                if (10 < game.getScore()) {
                    health -= game.getScore() / 10;
                } else {
                    health -= 1; // If player's health is lower than 10, decrement health by 1 instead.
                }
            }
        }
    ...
    /**
     * Function will teleport the player to the specified location and stop all
     * movement.
     *
     * precondition Game and player have been initialized. postcondition Player
     * has been moved.
     *
     ...
     *
     * precondition Display area exists. postcondition Player has been drawn.
     *
    ...
    /**
     * Function returns player's y position. precondition Player class has been
     * initialized.
     *
     * @return Y position.
     */
    ...
    /**
     * Function returns player's health. precondition Player class has been
     * initialized.
     *
     * @return Health.
     */
     ...
     *
     * precondition Player class has been initialized. postcondition Player
     * changed its left movement condition.
     *
     ...
     *
     * precondition Player class has been initialized. postcondition Player
     * changed its right movement condition.
     *
     * @param status Boolean that represents the status for movement.
     */
